			...
			.extend(
					a.jqx._jqxComboBox.prototype,
					{
						...
						render : function() {
							...
							m.host.append(g);
							m.dropdownlistWrapper = m.host
									.find("#dropdownlistWrapper");
							m.dropdownlistArrow = m.host
									.find("#dropdownlistArrow");
							m.dropdownlistContent = m.host
									.find("#dropdownlistContent");
							m.dropdownlistContent.addClass(m
									.toThemeProperty("jqx-combobox-content"));
							m.dropdownlistContent.addClass(m
									.toThemeProperty("jqx-widget-content"));
							m.dropdownlistWrapper[0].id = "dropdownlistWrapper"
									+ m.element.id;
							m.dropdownlistArrow[0].id = "dropdownlistArrow"
									+ m.element.id;
							m.dropdownlistContent[0].id = "dropdownlistContent"
									+ m.element.id;
							m.dropdownlistContent
							...
							try {
								...
								m.container = b;
								m.listBoxContainer = a(a.find("#innerListBox"
										+ m.id));
								var d = m.width;
								...
								m.container
										.height(parseInt(m.dropDownHeight) + 25);
								m.addHandler(m.listBoxContainer,
								...
								m.listBoxContainer
										.jqxListBox({
											...
											rendered : function() {
												m.listBox = a.data(
														m.listBoxContainer[0],
														"jqxListBox").instance;
												if (m.remoteAutoComplete) {
													if (m.autoDropDownHeight) {
														m.container
																.height(m.listBox.virtualSize.height + 25);
														m.listBoxContainer
																.height(m.listBox.virtualSize.height);
														m.listBox._arrange()
													} else {
														m.listBox._arrange();
														m.listBox
													...
													if (m.searchString != undefined
															&& m.searchString.length >= m.minLength) {
														var e = m.listBoxContainer
																.jqxListBox("items");
														if (e) {
															if (e.length > 0) {
																if (!m
								...
								m.listBoxContainer.css("border-top-width",
										"1px");
								m.listBoxContainer.addClass(m
										.toThemeProperty("jqx-popup"));
								if (a.jqx.browser.msie) {
									m.listBoxContainer.addClass(m
											.toThemeProperty("jqx-noshadow"))
								}
								m.listBox = a.data(m.listBoxContainer[0],
										"jqxListBox").instance;
								...
								m.listBox._arrange();
								m.addHandler(m.listBoxContainer, "unselect",
										function(e) {
											if (!m.multiSelect) {
												m._raiseEvent("3", {
													index : e.args.index,
								...
								m.addHandler(m.listBoxContainer, "change",
										function(e) {
											if (!m.multiSelect) {
												m._raiseEvent("4", {
													index : e.args.index,
							...
							m.dropdownlistArrowIcon.addClass(m
							...
							m.dropdownlistArrow.addClass(m
							...
							m._setSize();
							m._updateHandlers();
							m.addHandler(m.input, "keyup.textchange", function(
									e) {
								var s = m._search(e);
								if (m.cinput && m.input) {
							...
							if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
								if (m.host.parents(".jqx-window").length > 0) {
									var n = m.host.parents(".jqx-window").css(
											"z-index");
									b.css("z-index", n + 10);
						...
						_search : function(n) {
							...
							if (e.searchMode == "none" || e.searchMode == null
									|| e.searchMode == "undefined") {
								return
							}
							if (n.keyCode == 16 || n.keyCode == 17
									|| n.keyCode == 20) {
								return
							}
							if (e.checkboxes) {
							...
							if (e.multiSelect) {
								var o = a("<span style='visibility: hidden; white-space: nowrap;'>"
										+ e.input.val() + "</span>");
								...
								var g = parseInt(this._findPos(e.host[0])[1])
										+ parseInt(e.host.outerHeight()) - 1
										+ "px";
								var p = a.jqx.mobile.isSafariMobileBrowser()
										|| a.jqx.mobile.isWindowsPhone();
								var c = a.jqx.utilities.hasTransform(e.host);
								if (c || (p != null && p)) {
									g = a.jqx.mobile.getTopPos(this.element)
											+ parseInt(e.host.outerHeight());
							...
							if (n.keyCode == "13") {
								...
								if (n.keyCode == "27") {
									...
									if (!e.isOpened() && !e.opening
											&& !n.ctrlKey) {
										if (e.listBox.visibleItems
												&& e.listBox.visibleItems.length > 0) {
											if (e.input.val() != e.searchString
													&& e.searchString != undefined
													&& d != -1) {
									...
									.each(
											...
											function(i) {
												...
												if (m) {
													...
													var n = !e.rtl ? "right"
															: "left";
													var l = '<div style="position: relative; overflow: hidden; float: '
															+ n
													...
													if (a.jqx.browser.msie
															&& a.jqx.browser.version < 8) {
														l = '<div style="position: relative; overflow: hidden; float: left; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 100%; top: 50%; margin-left: -18px; margin-top: -7px; float: none; width: 16px; height: 16px;" class="'
																+ e
																		.toThemeProperty("jqx-icon-close")
																+ '"></div></div>'
													}
													if (e.rtl) {
														...
														if (a.jqx.browser.msie
																&& a.jqx.browser.version < 8) {
															l = '<div style="position: relative; overflow: hidden; float: left; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 0px; top: 50%; margin-top: -7px; float: none; width: 16px; height: 16px;" class="'
																	+ e
																			.toThemeProperty("jqx-icon-close")
																	+ '"></div></div>'
														}
						...
						_arrange : function() {
							...
							if (i > 0) {
								this.input[0].style.marginTop = parseInt(i)
										+ "px"
							}
							if (this.rtl) {
