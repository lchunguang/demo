...
<body>
	...
	<div class="info_div">
		<div class="search_header">
			<div class="title">
				<p class="min" title="click me to see the details">导入同工同酬工资条</p>
			</div>
					...
					<table cellpadding="5" cellspacing="0" style="width:1700px"
						...
						<thead>
							<tr style="border-bottom:1px solid #828282;" bgcolor="#eeeeee">
								...
								<th
									style="text-align:center;border-right:1px solid #828282;border-top:1px solid #828282;width:120px;">科室</th>
								<th
								...
								<th
									style="border-right:1px solid #828282;border-top:1px solid #828282;width:60px;">津贴</th>
								<th
								...
								<th
									style="border-right:1px solid #828282;border-top:1px solid #828282;width:60px;">工会会费</th>
								<th
								...
								<th
									style="border-right:1px solid #828282;border-top:1px solid #828282;width:60px;">房租</th>
								<th
								...
								<th
									style="border-right:1px solid #828282;border-top:1px solid #828282;width:60px;">实发工资</th>
								<th
						...
						<tbody>
							<core:forEach items="${salaryList}" var="dto" varStatus="status">
								<tr
									...
									<td style="border-right:1px solid #828282;width:60px;">${ dto.rentPay }</td>
